...
control_dict = {
    ...
    'use_SMASH_afterburner': False,    # flag to use SMASH as afterburner
...
# 3DMCGlauber model
smashini_dict = {
    'database_name_pattern': "SMASH_database/AuAu200/0_5",  # path for initial conditions
}
...
# MUSIC
music_dict = {
    'Initial_profile': 115,      # type of initial condition (11 or 111)
    ...
    'Initial_Distribution_input_filename': 'initial/ev.dat',
    'Initial_Rhob_Distribution_input_filename': 'initial/nb.dat',
    ...
    'eta_rhob_width_1': 0.093338,        # Gaussian width for |eta| > |eta_0|
    'eta_rhob_width_2': 0.989949,        # Gaussian width for |eta| < |eta_0|
    ...
    'Grid_size_in_eta': 201,         # number of the grid points in spatial rapidity direction
    ...
    'output_evolution_every_N_timesteps':30,  # output evolution every Ntime steps
...
iss_dict = {
    ...
    'use_OSCAR2013_format': 0,           # output results in OSCAR format
